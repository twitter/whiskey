...
public class ZlibInflater extends Inflater {
    ...
    /**
     * Creates a new instance with the default wrapper ({@link com.twitter.internal.network.whiskey.ZlibInflater.Wrapper#ZLIB}).
     */
    public ZlibInflater() {
     ...
     * is always {@link com.twitter.internal.network.whiskey.ZlibInflater.Wrapper#ZLIB} because it is the only format that
     ...
     * Be aware that only {@link com.twitter.internal.network.whiskey.ZlibInflater.Wrapper#GZIP}, {@link com.twitter.internal.network.whiskey.ZlibInflater.Wrapper#ZLIB} and {@link com.twitter.internal.network.whiskey.ZlibInflater.Wrapper#NONE} are
     * supported atm.
     */
